    ...
    <div id="id-portfolio-page" className={enlarge ? 'section-container portfolio-page active' : 'section-container portfolio-page'}>
      <div className="section-text">
        ...
        <div className="portfolio-grid">
          <Project delay={600} title='Job Search App' thumbnail={Project12Thumbnail} video={Project12} github='https://github.com/hasnat123/Mobile-Job-App' HandleEnlarge={HandleEnlarge}/>
          ...
          <Project delay={2200} title='Weather App' thumbnail={Project4Thumbnail} video={Project4} github='https://github.com/hasnat123/weather' HandleEnlarge={HandleEnlarge}/>
